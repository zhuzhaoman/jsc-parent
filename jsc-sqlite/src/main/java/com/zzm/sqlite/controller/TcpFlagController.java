...
public class TcpFlagController {
    ...
    public PagedGridResult getRuleList(@RequestParam Integer page,
        ...
        PagedGridResult pagedGridResult = tcpFlagService.getRuleList(page, pageSize);
    ...
    public PagedGridResult getRuleListByCriteria(@RequestParam Integer page,
        ...
        PagedGridResult pagedGridResult = tcpFlagService.getRuleListByCriteria(page, pageSize, criteria);
