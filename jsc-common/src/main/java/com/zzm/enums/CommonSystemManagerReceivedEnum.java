...
public enum CommonSystemManagerReceivedEnum {
    ...
    COMPILE_FULL_CHAR(1507, 1110, "编译全包浮动"),
    ...
    SHOW_RULE_PRIORITY(822, 1113, "查询规则优先级"),
    SHOW_RULE_TEMPLATE(820, 1113, "查询规则模板"),
    ...
    SYSTEM_DEL_DATA_ORIGIN(2147, 7770, "删除数据来源"),
    SYSTEM_CLEAN_DATA_ORIGIN(2149, 7770, "清除数据来源"),
    SYSTEM_GET_DATA_ORIGIN(2145, 7771, "获取数据来源"),
