 ...
 */
@Service
public class PortExtendSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_EXTEND.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_EXTEND.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("摔纤类型:").append(params.getInteger("m_u32WorkEable"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
