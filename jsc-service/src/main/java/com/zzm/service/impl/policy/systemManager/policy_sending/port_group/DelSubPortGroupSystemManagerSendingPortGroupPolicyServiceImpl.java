 ...
 **/
@Service
public class DelSubPortGroupSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_DEL_CHILD.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_DEL_CHILD.getMsg());
        try {
            ...
            content.append("【")
                    .append("子端口组ID:").append(m_u32AggPortGroup.toString())
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
