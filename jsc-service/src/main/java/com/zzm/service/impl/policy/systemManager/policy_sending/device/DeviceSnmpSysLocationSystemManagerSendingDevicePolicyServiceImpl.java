 ...
 */
@Service
public class DeviceSnmpSysLocationSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public String policyType() {
        return "device-snmp-sys-location";
    }
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SNMP_SYS_LOCATION.getReqCode(),
