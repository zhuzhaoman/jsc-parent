 ...
 */
@Service
public class PortSlotClearFlowSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageTypeEnum.INTERFACE_CLEAR_SLOT.getCode(),
                MessageCodeEnum.INTERFACE_SLOT_CLEAR_FLOW.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_SLOT_CLEAR_FLOW.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(portBO.getParam()));
            content.append("【")
                    .append("槽位ID:").append(params.getInteger("m_u32SlotId"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
