 ...
 */
@Service
public class DeviceDelSnmpCommunitySystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public String policyType() {
        return "device-del-snmp-community";
    }
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_DEL_SNMP_COMMUNITY.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("snmp配置 >>> " + MessageCodeEnum.DEVICE_DEL_SNMP_COMMUNITY.getMsg());
        try {
