 ...
 **/
@Service
public class ConfigSubGroupNameSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_CONFIG_CHILD_GROUP_NAME.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_CONFIG_CHILD_GROUP_NAME.getMsg());
        try {
            JSONObject params = JSONArray.parseArray(JSONObject.toJSONString(portGroupBO.getParam())).getJSONObject(0);

            content.append("【")
                    .append("子端口组ID:").append(params.getInteger("m_u32SubPortGroup")).append("、")
                    .append("子端口组名称:").append(params.getString("m_strDescription"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
