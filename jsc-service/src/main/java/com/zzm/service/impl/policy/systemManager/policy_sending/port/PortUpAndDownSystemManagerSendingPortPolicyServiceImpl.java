 ...
 */
@Service
public class PortUpAndDownSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_UP_AND_DOWN.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_UP_AND_DOWN.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("模式:").append(params.getInteger("m_u32Dir") == 0 ? "上行" : "下行")
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
