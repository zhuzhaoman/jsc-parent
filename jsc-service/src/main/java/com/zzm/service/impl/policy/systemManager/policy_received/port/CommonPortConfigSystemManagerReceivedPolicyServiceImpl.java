...
public class CommonPortConfigSystemManagerReceivedPolicyServiceImpl implements SystemManagerReceivedPolicyService {

    @Override
    public int policyMessageCode() {
        return MessageCodeEnum.COMMON_INTERFACE_CONFIG.getResCode();
    }
    ...
    public Object dataProcessing(ReceiveSystemManagerDTO receiveSystemManagerDTO) {
        ...
        if(receiveSystemManagerDTO.getCode() == 200) {
            receiveSystemManagerDTO.setMsg("端口配置成功！");
        }
