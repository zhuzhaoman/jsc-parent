 ...
 */
@Service
public class DeviceGatewayConfigSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_GATEWAY_CONFIG.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("设备系统配置 >>> " + MessageCodeEnum.DEVICE_GATEWAY_CONFIG.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("网关:").append(params.getString("m_strGwAddress"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
