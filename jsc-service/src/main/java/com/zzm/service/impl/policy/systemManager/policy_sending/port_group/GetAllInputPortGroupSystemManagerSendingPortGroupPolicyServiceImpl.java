 ...
 **/
@Service
public class GetAllInputPortGroupSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public String policyType() {
        return "show-all-input-port-group";
    }
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_GET_ALL_INPUT.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        OperationLog operationLog = OperationLog.builder().username(portGroupBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.PORT_GROUP_GET_ALL_INPUT.getMsg())
