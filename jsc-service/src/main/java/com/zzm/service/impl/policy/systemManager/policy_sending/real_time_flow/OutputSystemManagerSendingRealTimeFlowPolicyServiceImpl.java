 ...
 * @description 根据输出端口组，封装数据，发送给systemManager
 */
@Service
public class OutputSystemManagerSendingRealTimeFlowPolicyServiceImpl implements SystemManagerSendingRealTimeFlowPolicyService {
    ...
    public Object dataEncapsulation(RealTimeFlowBO realTimeFlowBO) throws Exception {
        ...
        param.put("portgroupId", Integer.parseInt(realTimeFlowBO.getParam()));
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.FIND_FLOW_BY_OUTPUT.getReqCode(),
    ...
    public void recordUserLog(RealTimeFlowBO realTimeFlowBO) {
        OperationLog operationLog = OperationLog.builder().username(realTimeFlowBO.getUsername())
                .operationTitle("流量管理")
                .operationContent("实时流量查询 >>> " + MessageCodeEnum.FIND_FLOW_BY_OUTPUT.getMsg())
