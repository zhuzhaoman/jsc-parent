 ...
 */
@Service
public class PortLoopBackSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_LOOP_BACK.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_LOOP_BACK.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("开关:").append(params.getInteger("m_u32LoopBackEnable") == 0 ? "关" : "开")
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
