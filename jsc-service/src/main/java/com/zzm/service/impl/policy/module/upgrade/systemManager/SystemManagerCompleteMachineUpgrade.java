 ...
 * @description:
 **/
public class SystemManagerCompleteMachineUpgrade extends Upgrade {
    ...
    public SystemManagerCompleteMachineUpgrade(MultipartFile[] files, String upgradePath, String sort) {
