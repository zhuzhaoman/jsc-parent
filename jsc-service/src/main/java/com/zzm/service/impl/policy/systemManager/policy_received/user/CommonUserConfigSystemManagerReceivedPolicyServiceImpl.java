...
public class CommonUserConfigSystemManagerReceivedPolicyServiceImpl implements SystemManagerReceivedPolicyService {

    @Override
    public int policyMessageCode() {
        return MessageCodeEnum.COMMON_USER_CONFIG.getResCode();
    }
    ...
    public Object dataProcessing(ReceiveSystemManagerDTO receiveSystemManagerDTO) {
        ...
        if(receiveSystemManagerDTO.getCode() == 200) {
            receiveSystemManagerDTO.setMsg("操作成功！");
        }
