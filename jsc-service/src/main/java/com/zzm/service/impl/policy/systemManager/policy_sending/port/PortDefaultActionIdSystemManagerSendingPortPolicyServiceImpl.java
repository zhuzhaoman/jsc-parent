 ...
 */
@Service
public class PortDefaultActionIdSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_DEFAULT_ACTION_ID.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_DEFAULT_ACTION_ID.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("业务策略:").append(params.getInteger("m_u32DefaultActionId"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
