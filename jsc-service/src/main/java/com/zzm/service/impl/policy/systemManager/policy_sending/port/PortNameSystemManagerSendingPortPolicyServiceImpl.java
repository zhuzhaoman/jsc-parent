 ...
 */
@Service
public class PortNameSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_NAME.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_NAME.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("端口描述:").append(params.getString("m_strPortDecr"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
