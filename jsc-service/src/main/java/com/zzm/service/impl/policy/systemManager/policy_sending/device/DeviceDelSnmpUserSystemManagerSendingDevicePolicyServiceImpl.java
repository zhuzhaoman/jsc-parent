 ...
 */
@Service
public class DeviceDelSnmpUserSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_DEL_SNMP_USER.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("snmp配置 >>> " + MessageCodeEnum.DEVICE_DEL_SNMP_USER.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("用户名:").append(params.getString("m_strUserName"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
