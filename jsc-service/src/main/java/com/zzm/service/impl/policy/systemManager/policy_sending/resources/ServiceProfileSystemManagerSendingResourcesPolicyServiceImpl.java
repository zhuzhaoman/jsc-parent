 ...
 **/
@Service
public class ServiceProfileSystemManagerSendingResourcesPolicyServiceImpl implements SystemManagerSendingResourcesPolicyService {
    ...
    public Object configDataEncapsulation(ResourcesBO resourcesBO) {
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SERVICE_PROFILE_RESOURCES_CONFIG.getReqCode());
    ...
    public Object getDataEncapsulation(ResourcesBO resourcesBO) {
        SendSystemManagerDTO sendSystemManagerDTO = getSendData(resourcesBO);
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SERVICE_PROFILE_RESOURCES_GET.getReqCode());
    ...
    public Object releaseDataEncapsulation(ResourcesBO resourcesBO) {
        SendSystemManagerDTO sendSystemManagerDTO = getSendData(resourcesBO);
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SERVICE_PROFILE_RESOURCES_CONFIG.getResCode());
        sendSystemManagerDTO.setMessageType(MessageTypeEnum.RESOURCES_CONFIG.getCode());
    ...
    public void recordConfigOrReleaseUserLog(ResourcesBO resourcesBO, boolean isConfig) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.SERVICE_PROFILE_RESOURCES_CONFIG.getMsg());
        ...
        try {
            ...
            content.append("【")
                    ...
                    .append("开始业务策略资源ID:").append(params.getInteger("m_u32SectionIdBegin")).append("、")
                    .append("结束业务策略资源ID:").append(params.getInteger("m_u32SectionIdEnd"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void recordGetUserLog(ResourcesBO resourcesBO) {
        ...
        OperationLog operationLog = OperationLog.builder().username(resourcesBO.getUsername())
                .operationTitle("资源配置")
                .operationContent(MessageCodeEnum.SERVICE_PROFILE_RESOURCES_GET.getMsg())
                .createTime(new Date()).build();
        logService.saveUserLog(operationLog);
    }
}
