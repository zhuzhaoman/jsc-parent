 ...
 * @description 根据槽位，封装数据，发送给systemManager
 */
@Service
public class SlotSystemManagerSendingRealTimeFlowPolicyServiceImpl implements SystemManagerSendingRealTimeFlowPolicyService {
    ...
    public Object dataEncapsulation(RealTimeFlowBO realTimeFlowBO) throws Exception {
        ...
        param.put("slotId", Integer.parseInt(realTimeFlowBO.getParam()));
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageTypeEnum.FIND_FLOW_BY_SLOT.getCode(),
                MessageCodeEnum.FIND_FLOW_BY_SLOT.getReqCode(),
    ...
    public void recordUserLog(RealTimeFlowBO realTimeFlowBO) {
        OperationLog operationLog = OperationLog.builder().username(realTimeFlowBO.getUsername())
                .operationTitle("流量管理")
                .operationContent("实时流量查询 >>> " + MessageCodeEnum.FIND_FLOW_BY_SLOT.getMsg())
