 ...
 **/
@Service
public class IpFragmentSystemManagerSendingServiceImpl implements SystemManagerSendingSystemPolicyService {
    ...
    public Object configDataEncapsulation(SystemBO systemBO){
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SYSTEM_CONFIG_IP_FRAGMENT.getReqCode());
    ...
    public void recordUserLog(SystemBO systemBO) {
        OperationLog operationLog = OperationLog.builder().username(systemBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.SYSTEM_CLEAN_DATA_ORIGIN.getMsg())
