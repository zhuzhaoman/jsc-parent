 ...
 **/
@Service
public class GetSubPortGroupSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_GET_CHILD.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        OperationLog operationLog = OperationLog.builder().username(portGroupBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.PORT_GROUP_GET_CHILD.getMsg())
