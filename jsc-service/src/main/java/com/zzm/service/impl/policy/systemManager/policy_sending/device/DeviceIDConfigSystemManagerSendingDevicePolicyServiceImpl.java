 ...
 */
@Service
public class DeviceIDConfigSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_ID_CONFIG.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("设备系统配置 >>> " + MessageCodeEnum.DEVICE_ID_CONFIG.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("ID描述:").append(params.getInteger("m_u32DeviceId"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
