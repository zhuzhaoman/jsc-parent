 ...
 */
@Service
public class DeviceUpdateSystemConfigSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SYSTEM_UPDATE_CONFIG.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        ...
        OperationLog operationLog = OperationLog.builder().username(deviceBO.getUsername())
                ...
                .operationContent("设备系统配置 >>> " + MessageCodeEnum.DEVICE_SYSTEM_UPDATE_CONFIG.getMsg())
