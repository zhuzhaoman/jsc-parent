 ...
 */
@Service
public class DeviceRebootSlotSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_REBOOT_SLOT.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("设备系统配置 >>> " + MessageCodeEnum.DEVICE_REBOOT_SLOT.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("槽位号:").append(params.getInteger("m_u32SlotId"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
