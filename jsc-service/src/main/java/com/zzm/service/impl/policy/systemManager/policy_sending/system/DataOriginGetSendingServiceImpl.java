 ...
 **/
@Service
public class DataOriginGetSendingServiceImpl implements SystemManagerSendingSystemPolicyService {
    ...
    public void recordUserLog(SystemBO systemBO) {
        OperationLog operationLog = OperationLog.builder().username(systemBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.SYSTEM_GET_DATA_ORIGIN.getMsg())
