 ...
 **/
@Service
public class SystemConfigSystemManagerSendingSystemPolicyServiceImpl implements SystemManagerSendingSystemPolicyService {
    ...
    public Object getDataEncapsulation(SystemBO systemBO){
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SYSTEM_GET_DATA_PROCESSING_INFO_QUERY.getReqCode());
    ...
    public void recordUserLog(SystemBO systemBO) {
        OperationLog operationLog = OperationLog.builder().username(systemBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.SYSTEM_GET_DATA_PROCESSING_INFO_QUERY.getMsg())
