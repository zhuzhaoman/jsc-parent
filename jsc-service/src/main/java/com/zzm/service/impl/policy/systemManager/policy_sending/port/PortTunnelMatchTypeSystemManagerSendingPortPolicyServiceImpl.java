 ...
 */
@Service
public class PortTunnelMatchTypeSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_TUNNEL_MATCH_TYPE.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_TUNNEL_MATCH_TYPE.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("模式:").append(params.getInteger("m_u32TunnelMatchType"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
