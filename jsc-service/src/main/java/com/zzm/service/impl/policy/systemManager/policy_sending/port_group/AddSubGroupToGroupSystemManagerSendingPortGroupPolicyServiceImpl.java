 ...
 **/
@Service
public class AddSubGroupToGroupSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_ADD_CHILD_GROUP_TO_INPUT_GROUP.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_ADD_CHILD_GROUP_TO_INPUT_GROUP.getMsg());
        try {
