 ...
 **/
@Service
public class DelPortGroupPortSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_DEL_PORT_TO_GROUP.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_DEL_PORT_TO_GROUP.getMsg());
        try {
