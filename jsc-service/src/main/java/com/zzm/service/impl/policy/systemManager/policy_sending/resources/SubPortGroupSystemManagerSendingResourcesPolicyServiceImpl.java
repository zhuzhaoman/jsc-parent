 ...
 **/
@Service
public class SubPortGroupSystemManagerSendingResourcesPolicyServiceImpl implements SystemManagerSendingResourcesPolicyService {
    ...
    public Object configDataEncapsulation(ResourcesBO resourcesBO) {
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SUBPORT_GROUP_RESOURCES_CONFIG.getReqCode());
    ...
    public Object getDataEncapsulation(ResourcesBO resourcesBO) {
        SendSystemManagerDTO sendSystemManagerDTO = getSendData(resourcesBO);
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SUBPORT_GROUP_RESOURCES_GET.getReqCode());
    ...
    public Object releaseDataEncapsulation(ResourcesBO resourcesBO) {
        SendSystemManagerDTO sendSystemManagerDTO = getSendData(resourcesBO);
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SUBPORT_GROUP_RESOURCES_RELEASE.getReqCode());
        sendSystemManagerDTO.setMessageType(MessageTypeEnum.RESOURCES_CONFIG.getCode());
        sendSystemManagerDTO.setData(resourcesBO.getParam());
