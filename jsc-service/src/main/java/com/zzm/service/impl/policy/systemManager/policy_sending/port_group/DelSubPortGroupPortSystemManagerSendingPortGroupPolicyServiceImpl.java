 ...
 **/
@Service
public class DelSubPortGroupPortSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_DEL_PORT_TO_CHILD_GROUP.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_DEL_PORT_TO_CHILD_GROUP.getMsg());
        try {
            ...
            content.append("【")
                    .append("输入端口组ID:").append(params.getInteger("m_u32SubPortGroup")).append("、")
