 ...
 */
@Service
public class DeviceIpConfigSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_IP_CONFIG.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("设备系统配置 >>> " + MessageCodeEnum.DEVICE_IP_CONFIG.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("host:").append(params.getString("m_strHostIpAddress")).append("、")
                    .append("host-mask:").append(params.getString("m_strMaskIpAddress")).append("、")
                    .append("back-up:").append(params.getString("m_strBackIpAddress"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
