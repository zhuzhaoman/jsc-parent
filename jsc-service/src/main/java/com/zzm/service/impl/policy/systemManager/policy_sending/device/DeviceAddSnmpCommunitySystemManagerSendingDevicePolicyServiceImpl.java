 ...
 */
@Service
public class DeviceAddSnmpCommunitySystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public String policyType() {
        return "device-add-snmp-community";
    }
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_ADD_SNMP_COMMUNITY.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("snmp配置 >>> " + MessageCodeEnum.DEVICE_ADD_SNMP_COMMUNITY.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("团体名:").append(params.getString("m_strCommunity"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
