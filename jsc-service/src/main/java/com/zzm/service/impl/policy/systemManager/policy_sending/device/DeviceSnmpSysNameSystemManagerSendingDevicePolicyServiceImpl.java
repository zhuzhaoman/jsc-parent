 ...
 */
@Service
public class DeviceSnmpSysNameSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SNMP_SYS_NAME.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        StringBuilder content = new StringBuilder("snmp配置 >>> " + MessageCodeEnum.DEVICE_SNMP_SYS_NAME.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(deviceBO.getParam()));
            content.append("【")
                    .append("名称:").append(params.getString("m_strSysName"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
