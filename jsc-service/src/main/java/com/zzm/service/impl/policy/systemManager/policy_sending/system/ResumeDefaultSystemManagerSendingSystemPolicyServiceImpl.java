 ...
 **/
@Service
public class ResumeDefaultSystemManagerSendingSystemPolicyServiceImpl implements SystemManagerSendingSystemPolicyService {
    ...
    public Object configDataEncapsulation(SystemBO systemBO){
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SYSTEM_CONFIG_RESUME_DEFAULT.getReqCode());
    ...
    private SendSystemManagerDTO getSendData(SystemBO systemBO) {
        ...
        return new SendSystemManagerDTO(
    ...
    public void recordUserLog(SystemBO systemBO) {
        OperationLog operationLog = OperationLog.builder().username(systemBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.SYSTEM_CONFIG_RESUME_DEFAULT.getMsg())
