 ...
 **/
@Service
public class DelServiceProfileSystemManagerSendingServiceProfilePolicyServiceImpl implements SystemManagerSendingServiceProfilePolicyService {
    ...
    public Object dataEncapsulation(ServiceProfileBO serviceProfileBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.SERVICE_PROFILE_DEL.getReqCode(),
    ...
    public void recordUserLog(ServiceProfileBO serviceProfileBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.SERVICE_PROFILE_DEL.getMsg());
        try {
