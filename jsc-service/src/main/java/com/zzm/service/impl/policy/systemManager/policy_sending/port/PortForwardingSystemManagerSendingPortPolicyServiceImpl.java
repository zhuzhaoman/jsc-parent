 ...
 */
@Service
public class PortForwardingSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_FORWARDING.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_FORWARDING.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("转发端口:").append(params.getInteger("m_u32ForwardingPortId"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
