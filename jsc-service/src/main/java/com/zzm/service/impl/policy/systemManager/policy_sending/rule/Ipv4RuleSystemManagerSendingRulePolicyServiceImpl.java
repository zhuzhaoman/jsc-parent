 ...
 **/
@Service
public class Ipv4RuleSystemManagerSendingRulePolicyServiceImpl extends BaseSystemManagerSendingPolicyServiceImpl implements SystemManagerSendingRulePolicyService {
    ...
    public Object addDataEncapsulation(RuleBO ruleBO) {
        ...
        IPV4RuleBO ipv4RuleBO = JSON.parseObject(JSON.toJSONString(ruleBO.getParam()), IPV4RuleBO.class);

        System.out.println("进入ipv4");

        System.out.println("前端发送数据：" + ruleBO.getParam());
        IPV4RuleDTO  ipv4RuleDTO = null;
        try {
            ipv4RuleDTO = (IPV4RuleDTO) ruleBO2DTO(ipv4RuleBO, IPV4RuleDTO.class);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.IPV4_RULE_ADD.getReqCode(),
                ruleBO.getUsername(),
                ruleBO.getDomainId(),
