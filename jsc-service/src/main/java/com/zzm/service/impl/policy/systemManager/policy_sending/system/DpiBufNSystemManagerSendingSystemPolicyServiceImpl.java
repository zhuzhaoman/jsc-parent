 ...
 **/
@Service
public class DpiBufNSystemManagerSendingSystemPolicyServiceImpl implements SystemManagerSendingSystemPolicyService {
    ...
    public Object configDataEncapsulation(SystemBO systemBO){
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.SYSTEM_CONFIG_DPI_BUF_N.getReqCode());
    ...
    public void recordUserLog(SystemBO systemBO) {
        OperationLog operationLog = OperationLog.builder().username(systemBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.SYSTEM_CONFIG_DPI_BUF_N.getMsg())
