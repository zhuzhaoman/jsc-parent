 ...
 */
@Service
public class DeviceShowSnmpServerSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public String policyType() {
        return "device-show-snmp-server";
    }
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SHOW_SNMP_CONFIG.getReqCode(),
