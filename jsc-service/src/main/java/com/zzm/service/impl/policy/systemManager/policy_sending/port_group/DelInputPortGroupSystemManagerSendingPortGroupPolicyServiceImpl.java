 ...
 **/
@Service
public class DelInputPortGroupSystemManagerSendingPortGroupPolicyServiceImpl implements SystemManagerSendingPortGroupPolicyService {
    ...
    public Object dataEncapsulation(PortGroupBO portGroupBO) {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.PORT_GROUP_DEL_INPUT.getReqCode(),
    ...
    public void recordUserLog(PortGroupBO portGroupBO) {
        StringBuilder content = new StringBuilder(MessageCodeEnum.PORT_GROUP_DEL_INPUT.getMsg());
        try {
            ...
            List<Integer> m_u32AggPortGroup = params.stream()
                    .map(param -> JSONObject.parseObject(param.toString())
                            .getInteger("m_u32AggPortGroup")).collect(Collectors.toList());

            content.append("【")
                    .append("输入端口组ID:").append(m_u32AggPortGroup.toString())
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
