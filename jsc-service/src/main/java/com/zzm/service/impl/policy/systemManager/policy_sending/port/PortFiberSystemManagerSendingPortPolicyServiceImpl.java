 ...
 */
@Service
public class PortFiberSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.INTERFACE_FIBER.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_FIBER.getMsg());
        try {
            ...
            content.append("【")
                    ...
                    .append("类型:").append(params.getInteger("m_u32FiberType") == 0 ? "双纤" : "单纤")
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
