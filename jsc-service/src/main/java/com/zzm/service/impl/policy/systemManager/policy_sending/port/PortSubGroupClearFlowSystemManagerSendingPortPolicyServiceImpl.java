 ...
 */
@Service
public class PortSubGroupClearFlowSystemManagerSendingPortPolicyServiceImpl implements SystemManagerSendingPortPolicyService {
    ...
    public String policyType() {
        return "port-sub-group-clear-flow";
    }
    ...
    public Object dataEncapsulation(PortBO portBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageTypeEnum.INTERFACE_CLEAR_GROUP_SUB.getCode(),
                MessageCodeEnum.INTERFACE_SUB_GROUP_CLEAR_FLOW.getReqCode(),
                portBO.getUsername(),
                portBO.getDomainId(),
    ...
    public void recordUserLog(PortBO portBO) {
        StringBuilder content = new StringBuilder("端口配置 >>> " + MessageCodeEnum.INTERFACE_SUB_GROUP_CLEAR_FLOW.getMsg());
        try {
            JSONObject params = JSONObject.parseObject(JSONObject.toJSONString(portBO.getParam()));
            content.append("【")
                    .append("子端口组ID:").append(params.getInteger("m_u32SubPortGroup"))
                    .append("】");
        } catch (Exception e) {
            e.printStackTrace();
        }
