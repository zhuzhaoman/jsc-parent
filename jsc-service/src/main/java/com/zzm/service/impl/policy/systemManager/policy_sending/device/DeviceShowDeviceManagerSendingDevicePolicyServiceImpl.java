 ...
 */
@Service
public class DeviceShowDeviceManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SHOW_DEVICE_MANAGE.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        OperationLog operationLog = OperationLog.builder().username(deviceBO.getUsername())
                .operationTitle("设备系统配置")
                .operationContent(MessageCodeEnum.DEVICE_SHOW_DEVICE_MANAGE.getMsg())
