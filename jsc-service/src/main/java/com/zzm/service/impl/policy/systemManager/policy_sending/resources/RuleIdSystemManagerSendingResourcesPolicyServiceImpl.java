 ...
 **/
@Service
public class RuleIdSystemManagerSendingResourcesPolicyServiceImpl implements SystemManagerSendingResourcesPolicyService {
    ...
    public Object configDataEncapsulation(ResourcesBO resourcesBO)  {
        ...
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.RULE_ID_RESOURCES_CONFIG.getReqCode());
    ...
    public Object getDataEncapsulation(ResourcesBO resourcesBO) {
        SendSystemManagerDTO sendSystemManagerDTO = getSendData(resourcesBO);
        sendSystemManagerDTO.setMessageCode(MessageCodeEnum.RULE_ID_RESOURCES_GET.getReqCode());
