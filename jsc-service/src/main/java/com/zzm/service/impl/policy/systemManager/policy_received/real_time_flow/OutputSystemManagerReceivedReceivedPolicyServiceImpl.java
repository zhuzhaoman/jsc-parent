...
public class OutputSystemManagerReceivedReceivedPolicyServiceImpl extends BaseSystemManagerReceivedPolicyServiceImpl implements SystemManagerReceivedPolicyService {


    @Override
    public int policyMessageCode() {
        return MessageCodeEnum.FIND_FLOW_BY_OUTPUT.getResCode();
    }
    ...
    public Object dataProcessing(ReceiveSystemManagerDTO receiveSystemManagerDTO) {
        ...
        if (code == 200) {
            receiveSystemManagerDTO.setMsg("获取输出端口流量成功！！！");
