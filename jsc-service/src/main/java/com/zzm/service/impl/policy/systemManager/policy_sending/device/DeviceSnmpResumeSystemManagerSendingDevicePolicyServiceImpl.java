 ...
 */
@Service
public class DeviceSnmpResumeSystemManagerSendingDevicePolicyServiceImpl implements SystemManagerSendingDevicePolicyService {
    ...
    public Object dataEncapsulation(DeviceBO deviceBO) throws Exception {
        ...
        SendSystemManagerDTO sendSystemManagerDTO = new SendSystemManagerDTO(
                ...
                MessageCodeEnum.DEVICE_SNMP_RESUME_DEFAULT.getReqCode(),
    ...
    public void recordUserLog(DeviceBO deviceBO) {
        OperationLog operationLog = OperationLog.builder().username(deviceBO.getUsername())
                ...
                .operationContent(MessageCodeEnum.DEVICE_SNMP_RESUME_DEFAULT.getMsg())
